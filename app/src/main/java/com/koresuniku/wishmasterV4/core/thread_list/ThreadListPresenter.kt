...
import com.koresuniku.wishmasterV4.core.base.BaseRxPresenter
import com.koresuniku.wishmasterV4.core.data.database.DatabaseHelper
import com.koresuniku.wishmasterV4.core.data.threads.ThreadListData
import com.koresuniku.wishmasterV4.core.data.threads.ThreadsMapper
import com.koresuniku.wishmasterV4.core.domain.thread_list_api.ThreadListApiService
import com.koresuniku.wishmasterV4.core.domain.thread_list_api.ThreadListJsonSchemaCatalogResponse
import com.koresuniku.wishmasterV4.core.domain.thread_list_api.ThreadListJsonSchemaPageResponse
...
class ThreadListPresenter @Inject constructor(): BaseRxPresenter<ThreadListView>() {
    ...
    override fun bindView(mvpView: ThreadListView) {
        ...
        mvpView.getWishmasterApplication().getDaggerNetComponent().inject(this)
        mvpView.getWishmasterApplication().getDaggerDatabaseComponent().inject(this)
        mvpView.getWishmasterApplication().getDaggerSharedPreferencesComponent().inject(this)
