...
import com.koresuniku.wishmasterV4.core.dashboard.DashboardView
...
import com.koresuniku.wishmasterV4.ui.view.widget.DashboardViewPager
...
class DashboardActivity : BaseWishmasterActivity(), DashboardView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getWishmasterApplication().getDaggerDashboardComponent().inject(this)
    ...
    private fun setupViewPager() {
        ...
        mCompositeDisposable.add(presenter.getPreferredTabPosition()
                .observeOn(AndroidSchedulers.mainThread())
